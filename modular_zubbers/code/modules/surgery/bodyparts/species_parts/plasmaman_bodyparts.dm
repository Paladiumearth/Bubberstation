/obj/item/bodypart/head/plasmaman
	...
	brute_modifier = 1.0 //Plasmemes are weak // diseases and raditation gutted rebuffed
	burn_modifier = 1.0 //Plasmemes are weak // diseases and raditation gutted rebuffed
